...
Lets have a go at making a histogram. Log-in to your RStudio Cloud account and go to your `tribolium_parasites` project. 
...
Your plot should appear in the plot tab in the bottom right panel of RStudio Cloud. 
...
Have a look at both of your histograms, what do you think they are showing? We will come back to histograms and how to read them in future lectures. 
...
A side note - if you remove the device line `ggsave` will automatically create a `.png` file. You can also use `width = , height = , units = "cm"` arguments to specify the size of your figure in cm. Try to incorporate these new arguments into the above chunk. Save both of your histogram outputs in your `figures` folder. 
