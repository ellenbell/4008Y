...
```{r, eval=TRUE, echo=FALSE, out.width="90%", fig.alt= "Tribolium parasite data raw", fig.cap ="Lab notes for wing case size (mm) and parasite burden of 20 _Tribolium castaneum_"}
