...
# A plot to choose from - Week 7A {#histogram}
...
## Looking at differences {#boxplot}
...
## Looking at relationships {#scatter}
...
You should have two histograms from last week (Chapter \@ref(histogram)) along with three boxplots (Chapter \@ref(boxplot)) and one scatter plot (Chapter \@ref(scatter)) from today saved in your `figures` folder. Check that they are saved and look as you would expect. Make sure to log out of posit Cloud and make sure you save your script!
...
# Make them pretty - Week 9A {#pretty-figs-p1}
...
# Make them pretty continued - Week 10A {#pretty-figs-p2}
...
# The subtle art of cannibalisation - Week 11A - Workshop 3 {#cannibalisation}
...
You hopefully also have two histograms saved in your `figures` folder (made in Chapter \@ref(histogram)); 
...
You hopefully also have a scatter plot saved in your `figures` folder (made in Chapter \@ref(scatter));
...
>>>>>>> 7c875222307693b9fb69a50ba3edddb75a89628b
...
<!--chapter:end:11-formative_assessment.Rmd-->
...
<!--chapter:end:12-merry_christmas.Rmd-->

# New year, new data - Workshop 4 - Athletes, Week 2B {#data-setup}
...
<!--chapter:end:13-new_year_new_data.Rmd-->

# Playing with some statistics - Workshop 5 - Athletes continued, Week 4B {#stats}
...
<!--chapter:end:14-playing_with_some_stats.Rmd-->
...
<!--chapter:end:15-reporting_analysis.Rmd-->
...
<!--chapter:end:16-portfolio_task.Rmd-->
