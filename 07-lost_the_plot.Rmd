...
Our other categorical variable is treatment. Using the script you already have try to write a new chunk of code to compare the differences between `wing_case_size` and `treatment` in our sample of _Tribolium_. 
...
```{r}
# Instruct R to the variable treatment as a factor 
