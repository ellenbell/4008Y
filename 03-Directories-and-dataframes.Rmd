...
Once again we can see that four of our variables have been interpreted by R as being `<dbl>` vectors, R has correctly identified them as being numeric. One of our variables has been identified as being a `<chr>` vector, so R knows that this variable contains letters or words. This all looks correct so we are ready to start to play with these data!

Well done everyone! Next week we will start to make some initial observations based on these data. 
