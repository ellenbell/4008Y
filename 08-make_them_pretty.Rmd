...
tribolium_combo <- read_csv("data/tribolium.combo.csv")
```
...
Clear accurate labeling is essential in the sciences be it when your in the lab labelling up your samples or creating data visualisations.
...
Our labels still aren't quite right, I don't like the abbreviations on the x axis and our legend could still use some work as there are no units given for the treatment temperatures. 
...
Remake your plot, what do you think?

## Switching up colours 

The colours of your boxes are the default colours in ggplot. We can modify these to make our plot look a bit more pleasing. Try editing the `scale_fill_manual` function to this `scale_fill_manual(labels = c("30°C", "35°C"), values = c("cornflowerblue", "coral"))`. Run it and see what happens to your plot. R has lots of [colours](https://www.datanovia.com/en/blog/awesome-list-of-657-r-color-names/), take a look at the reference lists and have a play with changing up some of your colours. 
