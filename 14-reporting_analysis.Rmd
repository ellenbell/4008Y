...
* Keep it biology focused - statistics be it inferential or descriptive are helpful when building an argument, you can use them to support your point, but the point should be biology driven. 
...
You may have noticed that in the last two chapters statistics have been reported in a very specific way. When reporting statistics, you should try to state what is shown and then include supporting information, in brackets, from the statistical analysis you have run. When reporting statitics, you should report;

* The statistical test used (e.g. T-test, ANOVA, etc)
* The test statistic (T or F for T-tests or ANOVA)
