...
\urlstyle{same}
\hypersetup{
  pdftitle={Introduction to Data Science - 4008Y},
  pdfauthor={Dr Ellen Bell},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Introduction to Data Science - 4008Y}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_1} \caption{Your workspace in posit Cloud}\label{fig:unnamed-chunk-1}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_2} \caption{Creating a new project in posit Cloud}\label{fig:unnamed-chunk-2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_3} \caption{Renaming your project}\label{fig:unnamed-chunk-3}
\end{figure}

You will see that your new project has three panels with tabs showing the Console, Environment and Files for your project.

\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_4} \caption{The three basic panels of an R Studio workspace}\label{fig:unnamed-chunk-4}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_5} \caption{How to make your project more efficient}\label{fig:unnamed-chunk-5}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_6} \caption{How to create a new R script}\label{fig:unnamed-chunk-11}
\end{figure}

\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_rstudiocloud_7} \caption{The four panels of an R Studio workspace}\label{fig:unnamed-chunk-12}
\end{figure}
...
\hypertarget{directories-and-data-frames---week-4a---workshop-1}{%
\chapter{Directories and data frames - Week 4A - Workshop 1}\label{directories-and-data-frames---week-4a---workshop-1}}

This week we don't have any lectures but we do have an in person workshop. The section to complete this week may be a little more chunky than unusual, complete what you can during the workshop and then finish it off in your own time. Do make use of the demonstrators if any of the exercises so far haven't made sense.
...
\hypertarget{setting-up-your-r-workspace}{%
\section{Setting up your R workspace}\label{setting-up-your-r-workspace}}
...
\tightlist
\item
  \textbf{absolute} paths, which refer to the same location in a file system relative to the root directory (don't worry if that doesn't make too much sense at this stage).
\item
  \textbf{relative} paths, which refer to a location in the file system relative to the directory you are currently working in.
\end{itemize}
...
\hypertarget{setting-up-your-script}{%
\section{Setting up your script}\label{setting-up-your-script}}

Right OK, enough theory, lets start setting up your script. Create a new R script by clicking on the icon with a little green plus, below File in the top left of the posit Cloud windown and select \textbf{R Script}. Call your new script \texttt{tribolium\_parasites}. Its always good to add a few lines of description at the start of your script, this tells your future self and anyone else what the script is doing. Copy over the following.
...
\hypertarget{exploring-the-dimensions-of-your-data-frame---week-6a}{%
\chapter{Exploring the dimensions of your data frame - Week 6A}\label{exploring-the-dimensions-of-your-data-frame---week-6a}}
...
\hypertarget{a-plot-to-choose-from---week-7a}{%
\chapter{A plot to choose from - Week 7A}\label{a-plot-to-choose-from---week-7a}}
...
\hypertarget{exporting-your-histogram}{%
\section{Exporting your histogram}\label{exporting-your-histogram}}

You are going to want to save your plots, you can use the \texttt{ggsave} function to do this.
...
\hypertarget{looking-at-differences}{%
\section{Looking at differences}\label{looking-at-differences}}
...
\hypertarget{looking-at-relationships}{%
\section{Looking at relationships}\label{looking-at-relationships}}
...
\hypertarget{make-them-pretty---week-9a}{%
\chapter{Make them pretty - Week 9A}\label{make-them-pretty---week-9a}}
...
Check your data has loaded correctly. Can you remember how to change \texttt{treatment} from a \texttt{dbl} vector to a factor (\texttt{fct})?
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_deconstructingaplot_1} \caption{The most basic output from ggplot}\label{fig:unnamed-chunk-49}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/screenshot_deconstructingaplot_2} \caption{A basic ggplot box plot output}\label{fig:unnamed-chunk-51}
\end{figure}
...
This is because \texttt{scale\_fill\_manual} is also expecting some instructions on how to colour your boxplot. You will need to complete section 9.3 before you can successfully remake your boxplot.

\hypertarget{switching-up-colours}{%
\section{Switching up colours}\label{switching-up-colours}}
...
\hypertarget{make-them-pretty-continued---week-10a}{%
\chapter{Make them pretty continued - Week 10A}\label{make-them-pretty-continued---week-10a}}

You should aim to complete this chapter in Week 10, Semester 1

In Chapter 9 we explored the fundamental functionality of \texttt{ggplot2} and we started to play with some functions that improved our plots labels and colour scheme. This week we will be extending this further and investigating how we may also be able to alter spacing and themes to improve the appearance of our plots.
...
\hypertarget{the-subtle-art-of-cannibalisation---week-11a---workshop-3}{%
\chapter{The subtle art of cannibalisation - Week 11A - Workshop 3}\label{the-subtle-art-of-cannibalisation---week-11a---workshop-3}}
...
In Chapters 9 and 10 we specifically worked on making changes to our box plots that would make them clean, clear and visually pleasing. You have all the code already made for your box plots, it just needs tailoring a little. You should have three boxplots saved in your \texttt{figures} folder;
...
\item
  size\_differences\_boxplot.pdf - remember this is filled by \texttt{sex} not \texttt{treatment} so will be subtly different to the figure made in the \texttt{ggplot\_fundamentals.R} script that we worked on in Chapters 9 and 10.
\end{itemize}
...
You hopefully also have two histograms saved in your \texttt{figures} folder;
...
You hopefully also have a scatter plot saved in your \texttt{figures} folder;
...
\hypertarget{end-of-semester-1}{%
\section{End of Semester 1}\label{end-of-semester-1}}
...
\hypertarget{new-year-new-data---workshop-4---athletes-week-2b}{%
\chapter{New year, new data - Workshop 4 - Athletes, Week 2B}\label{new-year-new-data---workshop-4---athletes-week-2b}}
...
Generally I recommend starting a new R Project every time you start working on new and unrelated data sets. Go to posit Cloud, open a \textbf{New R Studio Project} and name it \texttt{athletes}. Spend a few minutes setting up your workspace, refer back to \textbf{Chapter 4.3} to remind yourself of how to do this. Remember you will need to create sensible places to save scripts, data and figures. You will also need to freshly install any required packages.
...
Its fairly safe to say we will be creating some new scripts so open a new \textbf{R script} and set it up as described in \textbf{Chapter 4.5}. The project title will be \emph{An analysis of red blood cell counts among athletes}. Remember to use \texttt{library()} to load your freshly installed packages.
...
\hypertarget{playing-with-some-statistics---workshop-5---athletes-continued-week-4b}{%
\chapter{Playing with some statistics - Workshop 5 - Athletes continued, Week 4B}\label{playing-with-some-statistics---workshop-5---athletes-continued-week-4b}}
...
\hypertarget{reporting-your-analysis---workshop-6---athletes-continued-week-6b}{%
\chapter{Reporting your analysis - Workshop 6 - Athletes continued, Week 6B}\label{reporting-your-analysis---workshop-6---athletes-continued-week-6b}}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/multipanel} \caption{Results from the patchwork demonstration chunk}\label{fig:unnamed-chunk-77}
\end{figure}
...
\hypertarget{writing-about-your-analysis}{%
\section{Writing about your analysis}\label{writing-about-your-analysis}}
...
\hypertarget{task-3---writing-a-figure-legend}{%
\subsection{Task 3 - Writing a figure legend}\label{task-3---writing-a-figure-legend}}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/cory} \caption{*Corydoras araguaiaensis*}\label{fig:unnamed-chunk-78}
\end{figure}
...
\hypertarget{exercise-1---plots}{%
\subsection{Exercise 1 - plots}\label{exercise-1---plots}}
...
Set up a new R studio project, import the catfish\_parasites data and make sure it is clean and tidy. Complete all the checks that you did in \textbf{Chapter 13} and then you can start exploring the data (\textbf{Chapter 13 and 14}). When you are satisfied with the data quality and appearance you can begin to answer the questions above. Construct a plot to address each of these questions. I suggest a plot per question. Make them visually pleasing and then combine the three plots into a multi-panel figure (\textbf{Chapter 15}). Export this as a pdf, you will be able to download this pdf to your own computer when you are happy with it (you may need to open it in your browser and then click the download button in the top right hand corner of the screen). Present these plots in your portfolio for Task 3.

\hypertarget{exercise-2---figure-legend}{%
\subsection{Exercise 2 - figure legend}\label{exercise-2---figure-legend}}

We have discussed figure legends in lectures and in \textbf{Chapter 15}, write a good figure legend underneath your newly made figure within Task 3 of your portfolio.

\hypertarget{exercise-3---justification}{%
\subsection{Exercise 3 - justification}\label{exercise-3---justification}}
...
\hypertarget{exercise-4---proof-of-programing}{%
\subsection{Exercise 4 - proof of programing}\label{exercise-4---proof-of-programing}}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/code_example} \caption{ggplot chunk}\label{fig:unnamed-chunk-79}
\end{figure}
